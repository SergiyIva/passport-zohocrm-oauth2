 ...
 *   - `callbackURL`   URL to which Zoho CRM will redirect the user after granting authorization
 *   - `scope`         array of permission scopes to request. Default is `AaaServer.profile.Read`
 *
 * Examples:
 *
...
function Strategy(options, verify) {
    ...
    options.scope = options.scope || "AaaServer.profile.Read"
